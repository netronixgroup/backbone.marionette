...
export { bindEvents, unbindEvents, bindRequests, unbindRequests, mergeOptions, getOption, normalizeMethods, triggerMethod$$1 as triggerMethod, setDomApi, setRenderer, View, CollectionView, MarionetteObject as MnObject, Region, Behavior, Application, isEnabled, setEnabled, monitorViewEvents, Events, extend, DomApi, version as VERSION };export default backbone_marionette;
